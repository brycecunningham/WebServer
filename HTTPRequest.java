...
final class HTTPRequest {
    ...
    // This method will read the Connection type from the header and return whether Keep-Alive or not
    public boolean isKeepAlive() {
		if (headers.get("Connection") == null || headers.get("Connection").equals("Keep-Alive") || headers.get("Connection").equals("keep-alive")){
		    return true;
		} else {
